...
SPELL_SLOTS_TABLE_MAP = {
    ...
    ClassType.WIZARD: WIZARD_SPELL_SLOTS_TABLE,
}

def get_class_level_spell_slots(class_type: ClassType, level: int):
    """Return the number of slots of each spell level a class has for a given level."""
    return SPELL_SLOTS_TABLE_MAP[class_type][level]
